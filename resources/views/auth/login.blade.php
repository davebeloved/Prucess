...
<div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
    ...
    <div class="app-auth-container">
        <div class="logo">
            <!-- <img src="../../../public/images/neptune.png" alt="logo"> -->
            <!-- <a style="text-decoration: none;" href="{{ env ('APP_URL') }}"><img src="https://prucess.com/wp-content/uploads/2024/01/Prucess_Logo-removebg-1-e1704976458870.png" alt="logo"> {{ env('APP_NAME') }}</a> -->
            <img src="https://prucess.com/wp-content/uploads/2024/01/Prucess_Logo-removebg-1-e1704976458870.png" alt="logo">
        </div>
